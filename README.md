...
- [Preparazione ambiente](#preparazione-ambiente-per-build-con-python)
- [Integrazione di Ollama](#-integrazione-di-ollama)
- [Integrazione di ClamAV](#-integrazione-di-clamav)
- [Installazione di Radare2 e r2ai](#-installazione-di-radare2-e-r2ai)
- [Guida d'uso](#guida-duso-per-eseguibile-securitymonsterexe)
- [Tabelle e screenshot](#tabelle-e-screenshots-dei-test-effettuati)
  - [Analisi codice sorgente](#-securitymonster-analisi-codice-sorgente)
